...
import PrivacyLayoutClient from "@/components/sections/PrivacyLayoutClient";
  ...
  if (!data || !data.sections) {
    return (
      <div className="w-full min-h-[50vh] flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-xl font-black text-neutral-900 mt-1">Privacy Content Empty</h2>
        <p className="text-xs text-neutral-500 max-w-sm mt-2 font-normal leading-relaxed">
          Deploy a document under the type schema <code className="bg-neutral-100 px-1 py-0.5 rounded text-[#E87C36]">privacyPage</code> within Sanity Studio to fill out this page structure.
        </p>
      </div>
    );
  }
